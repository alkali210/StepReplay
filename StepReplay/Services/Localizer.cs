...
public sealed class Localizer
{
    ...
    private static readonly Dictionary<string, string> Zh = new()
    {
        ...
        ["Status.HotkeyStartFailed"] = "全局快捷键启动失败：{0}",
        ...
        ["Settings.Theme"] = "界面主题",
        ["Settings.Theme.Default"] = "跟随系统",
        ["Settings.Theme.Light"] = "浅色",
        ["Settings.Theme.Dark"] = "深色",
        ["Settings.Backdrop"] = "窗口背景",
        ["Settings.Backdrop.Mica"] = "Mica（默认）",
        ["Settings.Backdrop.MicaAlt"] = "Mica Alt",
        ["Settings.RecordDelay"] = "开始录制延迟（秒）",
        ["Settings.ReplayDelay"] = "开始回放延迟（秒）",
        ["Settings.ReplayRepeatCount"] = "回放次数",
        ["Settings.ShowMouseMoves"] = "在列表中显示鼠标轨迹记录",
        ["Settings.Hotkeys"] = "快捷键",
        ["Settings.Hotkey.StartRecording"] = "开始录制",
        ["Settings.Hotkey.StopRecording"] = "结束录制",
        ["Settings.Hotkey.StartReplay"] = "开始回放",
        ["Settings.Hotkey.StopReplay"] = "停止回放",
        ["Settings.Hotkey.Unset"] = "未设置",
        ["Settings.HotkeyInvalid"] = "快捷键格式无效。请使用类似 Ctrl+Alt+R 的格式，或留空表示不设置。",
        ["Settings.HotkeyConflict"] = "快捷键与“{0}”冲突，请选择另一个组合。",
        ["Settings.HotkeyPressPrompt"] = "请按下要设置的快捷键组合，例如 Ctrl+Alt+R；按 Backspace/Delete 可清除。",
        ["Settings.HotkeyNeedModifier"] = "快捷键至少需要包含 Ctrl、Alt、Shift 或 Win 中的一个修饰键。",
        ["Settings.HotkeyCaptureCanceled"] = "已取消快捷键录制",
        ["Settings.HotkeyCleared"] = "快捷键已清除",
    ...
    private static readonly Dictionary<string, string> En = new()
    {
        ...
        ["Status.RecordCanceled"] = "Recording canceled",
        ...
        ["Status.ReplayingRepeat"] = "Replaying... {0:N0}/{1:N0}",
        ["Status.ReplayComplete"] = "Replay complete",
        ["Status.ReplayCompleteRepeat"] = "Replay complete ({0:N0} runs)",
        ...
        ["Status.HotkeyStartFailed"] = "Failed to start global hotkeys: {0}",
        ...
        ["Settings.Theme.Default"] = "Use system setting",
        ["Settings.Theme.Light"] = "Light",
        ["Settings.Theme.Dark"] = "Dark",
        ["Settings.Backdrop"] = "Window backdrop",
        ["Settings.Backdrop.Mica"] = "Mica (default)",
        ["Settings.Backdrop.MicaAlt"] = "Mica Alt",
        ["Settings.RecordDelay"] = "Recording start delay (seconds)",
        ["Settings.ReplayDelay"] = "Replay start delay (seconds)",
        ["Settings.ReplayRepeatCount"] = "Replay count",
        ["Settings.ShowMouseMoves"] = "Show mouse path records in the list",
        ["Settings.Hotkeys"] = "Hotkeys",
        ["Settings.Hotkey.StartRecording"] = "Start recording",
        ["Settings.Hotkey.StopRecording"] = "Stop recording",
        ["Settings.Hotkey.StartReplay"] = "Start replay",
        ["Settings.Hotkey.StopReplay"] = "Stop replay",
        ["Settings.Hotkey.Unset"] = "Not set",
        ["Settings.HotkeyInvalid"] = "Invalid hotkey format. Use a format like Ctrl+Alt+R, or leave it empty to disable it.",
        ["Settings.HotkeyConflict"] = "This hotkey conflicts with \"{0}\". Choose another combination.",
        ["Settings.HotkeyPressPrompt"] = "Press the hotkey combination to use, for example Ctrl+Alt+R. Press Backspace/Delete to clear.",
        ["Settings.HotkeyNeedModifier"] = "A hotkey must include at least one modifier: Ctrl, Alt, Shift, or Win.",
        ["Settings.HotkeyCaptureCanceled"] = "Hotkey capture canceled",
        ["Settings.HotkeyCleared"] = "Hotkey cleared",
